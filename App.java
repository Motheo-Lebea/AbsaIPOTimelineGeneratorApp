...
public class App extends JFrame {
    ...
    private void createUI() {
        setTitle("Absa IPO Timeline Generator");
        ...
        headerPanel.setBackground(new Color(220, 180, 180));
        JLabel titleLabel = new JLabel("Absa IPO Timeline Generator");
    ...
    private void generateTimeline(ActionEvent e) {
        try {
            ...
            List<AbsaIPOTimelineGenerator.IPOPhase> timeline =
                    AbsaIPOTimelineGenerator.generateTimeline(ipoDate);

            Object[][] data = new Object[timeline.size()][3];
            for(int i = 0; i < timeline.size(); i++) {
                AbsaIPOTimelineGenerator.IPOPhase phase = timeline.get(i);
